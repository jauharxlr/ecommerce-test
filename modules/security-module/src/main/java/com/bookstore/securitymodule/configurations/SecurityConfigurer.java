package com.bookstore.securitymodule.configurations;

import com.bookstore.securitymodule.filters.AuthRequestFilter;
...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		List allowedEndPoints = new ArrayList(Arrays.asList(
				"/swagger-ui/**",
				"/swagger-resources/**",
				"/swagger-ui.html",
				"/v2/api-docs",
